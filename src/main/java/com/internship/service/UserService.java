...
public class UserService {
    ...
    public List<UserDto> getUsers(String status) {
        ...
        List<UserDto> dtos = users.stream().map(UserDto::mapEntityToDo).collect(Collectors.toList());
        List<UserWrapper> allUsersWithWrapper = userRepository.findAllUsersWithWrapper(status);
