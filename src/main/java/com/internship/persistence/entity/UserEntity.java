...
public class UserEntity {
    ...
    @OneToMany(mappedBy = "user", targetEntity = UserCommunityEntity.class, fetch = FetchType.LAZY)
    private List<UserCommunityEntity> listOfUserCommunities;

    @OneToOne(mappedBy = "user", targetEntity = UserDetailEntity.class, fetch = FetchType.LAZY, optional = false)
